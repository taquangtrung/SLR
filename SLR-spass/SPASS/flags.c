...
***************************************************************/
static void flag_InitIntern (FLAG_ID Flag, FLAG_TYPE Type,
...
***************************************************************/
{
  ...
  flag_InitIntern(flag_SPLITHEURISTIC, flag_UNIQUE, "SplitHeuristic", flag_SPLITHEURISTICSTANDARD,
  ...
  flag_InitIntern(flag_QUANTEXCH, flag_TRANSFORM, "CNFQuantExch", flag_QUANTEXCHOFF,
		  flag_QUANTEXCHMIN, flag_QUANTEXCHMAX);
 ...
 /* Assignment Equation Deletion output not activated  */
  ...
  flag_InitIntern(flag_CNFRENAMING, flag_UNIQUE, "CNFRenaming", flag_CNFRENAMINGOPT,
   ...
   * literal */
  flag_InitIntern(flag_CNFRENMATCH, flag_TRANSFORM, "CNFRenMatch", flag_CNFRENMATCHON,
  ...
  flag_InitIntern(flag_EML, flag_EMLSPECIAL, "EML", flag_EMLOFF,
		  flag_EMLMIN, flag_EMLMAX);

  /* Autonomous mode, as yet not functional */
  flag_InitIntern(flag_EMLAUTO, flag_EMLSPECIAL, "EMLAuto", flag_EMLAUTOON,
  ...
  flag_InitIntern(flag_EML2REL, flag_EMLSPECIAL, "EML2Rel", flag_EML2RELOFF,
  ...
  flag_InitIntern(flag_EMLTR, flag_EMLSPECIAL, "EMLTranslation", flag_EMLTRREL,
		  flag_EMLTRMIN, flag_EMLTRMAX);

  /* Determines which background theory is assumed */
  flag_InitIntern(flag_EMLTHEORY, flag_EMLSPECIAL, "EMLTheory", flag_EMLTHEORYK,
  ...
  flag_InitIntern(flag_EMLFUNCNDEQ, flag_EMLSPECIAL, "EMLFuncNdeQ", flag_ON,
		  flag_EMLFUNCNDEQMIN, flag_EMLFUNCNDEQMAX);

  /* If set the functional translation into fluted logic is used */
  flag_InitIntern(flag_EMLFNARY, flag_EMLSPECIAL, "EMLFuncNary", flag_EMLFNARYOFF,
		  flag_EMLFNARYMIN, flag_EMLFNARYMAX);

  /* If set sorts for terms are used */
  flag_InitIntern(flag_EMLFFSORTS, flag_EMLSPECIAL, "EMLFFSorts", flag_EMLFFSORTSOFF,
		  flag_EMLFFSORTSMIN, flag_EMLFFSORTSMAX);

  /* If set try to eliminate composition */
  flag_InitIntern(flag_EMLELIMCOMP, flag_EMLSPECIAL, "EMLElimComp", flag_EMLELIMCOMPOFF,
		  flag_EMLELIMCOMPMIN, flag_EMLELIMCOMPMAX);

  /* If set the translation to FOL is printed */
  flag_InitIntern(flag_EMLPTRANS, flag_EMLSPECIAL, "EMLPTrans", flag_EMLPTRANSOFF,
...
***************************************************************/
{
  flag_FPrintFlagWithValue(File, Store, Flag, flag_GetFlagValue(Store, Flag));
}

void flag_FPrintFlagWithValue(FILE* File, FLAGSTORE Store, FLAG_ID Flag, int Value)
/**************************************************************
  INPUT:   A File to print to, a FlagStore, and a Flag.
  RETURNS: Nothing.
  EFFECT:  Prints the value of the Flag in the FlagStore to 
...
***************************************************************/
{
  fprintf(File,"\nset_flag(%s,%d).", flag_Name(Flag), Value);
}
...
int flag_GetFlagValue(FLAGSTORE Store, FLAG_ID FlagId)
/**************************************************************
...
void flag_SetFlagValue(FLAGSTORE Store, FLAG_ID FlagId, int Value)
/**************************************************************
...
***************************************************************/
{
  ...
  flag_TransferFlag(Source, Target, flag_QUANTEXCH);
...
void flag_PrintEmlTranslationMethod(FLAG flag)
/**************************************************************
  INPUT:   A FlagStore.
  RETURNS: Nothing.
...
void flag_CheckEmlTranslationFlags(FLAGSTORE Store, FLAG flag)
/**************************************************************
  INPUT:   A FlagStore.
  RETURNS: Nothing.
...
***************************************************************/
{
   ...
   * setting flag_QUANTEXCH would have no effect */
  if (flag_GetFlagValue(Store, flag_QUANTEXCH) && flag_GetFlagValue(Store, flag_CNFOPTSKOLEM)) {      
    printf("\nWarning: Flag %s is incompatible with flag %s; ",
	  flag_Name(flag_CNFOPTSKOLEM), flag_Name(flag_QUANTEXCH));
    printf("\n    always use %s together with both %s and %s disabled \n",
	  flag_Name(flag_QUANTEXCH), flag_Name(flag_CNFOPTSKOLEM), flag_Name(flag_CNFSTRSKOLEM));
    flag_SetFlagValue(Store, flag_CNFOPTSKOLEM, flag_CNFOPTSKOLEMOFF);
    /* Alternatively, make the prover abort at this point,
     * or fix the dependency of cnf_Init of flag_CNFSTRSKOLEM */
  }
  if (flag_GetFlagValue(Store, flag_QUANTEXCH) && flag_GetFlagValue(Store, flag_CNFSTRSKOLEM)) {      
    printf("\nWarning: Flag %s is incompatible with flag %s; ",
	  flag_Name(flag_CNFSTRSKOLEM), flag_Name(flag_QUANTEXCH));
    printf("\n    always use %s together with both %s and %s disabled \n",
	  flag_Name(flag_QUANTEXCH), flag_Name(flag_CNFOPTSKOLEM), flag_Name(flag_CNFSTRSKOLEM));
    flag_SetFlagValue(Store, flag_CNFSTRSKOLEM, flag_CNFSTRSKOLEMOFF);
