...
typedef struct term {
	...
	LIST justification; // list cac justification (moi justification la 1 term)
...
BOOL term_HasProperSuperterm(TERM, TERM);
	...
	BOOL term_HasJustification(TERM);
 ...
 ***************************************************************/
{
	return list_DeleteDuplicatesFree(Terms, (BOOL(*)(POINTER, POINTER)) term_Equal, (void(*)(
			POINTER)) term_Delete);
}
