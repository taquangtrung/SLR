...
static __inline__ TERMARRAY table_GetPos(TABLE table, int tab_index)
{
...
static __inline__ TABLE table_SetPos(TABLE table, int tab_index, TERMARRAY ta)
{
...
static __inline__ int table_GetPosstamp(TABLE table, int tab_index)
{
...
static __inline__ TABLE table_SetPosstamp(TABLE table, int tab_index, int stamp)
{
...
static __inline__ BOOL table_LegalPosIndex(TABLE table, int tab_index)
{
...
static __inline__ BOOL table_PosStamped(TABLE table, int tab_index)
{
  return table_GetPosstamp(table, tab_index) == table_GetStampcounter(table);
}


static __inline__ int table_DelayedPosInit(TABLE table, int tab_index)
/***************************************************************
